...
%c% -I.. -I../.. -I../../colamd -I../../shared -Ilusol -I. /LD /MT /O2 /Zp8 /Gz -D_WINDLL -D_USRDLL -DWIN32 -DRoleIsExternalInvEngine -DINVERSE_ACTIVE=INVERSE_LUSOL -D_CRT_SECURE_NO_DEPRECATE %src% /Febin\%PLATFORM%\bfp_LUSOL.dll
...
rem mt /outputresource:"bin\%PLATFORM%\bfp_LUSOL.dll;#2" /manifest "bin\%PLATFORM%\bfp_LUSOL.dll.manifest"
